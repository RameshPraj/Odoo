...
JS tests can sit in the repository for years without ever executing. Same pattern
as ``account_reports_interactive/tests/test_js_unit.py`` and
``nepali_calendar_core/tests/test_js_unit.py``; see the latter for the reasoning
behind the suite-id hash.
