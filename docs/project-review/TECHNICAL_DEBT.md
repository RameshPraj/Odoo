...
it. As of 2026-08-19 it exits 0 (**326 tests, 0 failed**), so a green baseline now exists to protect;
the gap that remains is automation, not correctness. No linter configured despite `# noqa` annotations
throughout —
