...
| `deploy/README.md` | `wkhtmltopdf` not installed; every PDF report currently fails | Open, and a go-live gate. Note FIN-2 means the statements would fail even with it installed |
