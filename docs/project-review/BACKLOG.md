...
>
> The count includes entries already closed. **7 are RESOLVED** — FIN-2, FIN-3, OPS-1, OPS-7, BS-20,
> DEP-1, TST-8 — and CI-1 is PARTIALLY RESOLVED, so the open figure is 116.
>
