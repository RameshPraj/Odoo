...
6 P4** (122 table entries; `DEP-3/4/5` is one row covering three). Seven are RESOLVED — FIN-2, FIN-3,
OPS-1, OPS-7, BS-20, DEP-1, TST-8 — and CI-1 is partially resolved, so **117 remain open**. This line previously read "88
