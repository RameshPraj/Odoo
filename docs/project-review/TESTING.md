...
**121 test methods across 8 modules, and nothing runs them.** The volume is respectable. The
placement is not: **every one of the four correctness defects in this audit is covered by a green
test that exercises the wrong layer.**
